    ...
    >
      ...
      <m.div variants={varFade().inUp}>
        <Typography sx={{ color: 'common.white' }}>
            Our goal is to create a platform that you'll love and use every day.
            That's why we're constantly improving Watchit to provide the best experience
            possible and truly listen to our users' feedback.
        </Typography>
      </m.div>
    </Box>
  );
